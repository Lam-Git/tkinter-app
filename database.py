...
def query():
    ...
    # Query the database.. "oid" = primary key [meaning its the number next to the data. ]
    c.execute("SELECT *, oid FROM addresses ")
    records = c.fetchall()
    # create_a_variable =fetchone(any number), fetchmany(any number)
    # --------print(records)  # the information will be printed in the terminal.
